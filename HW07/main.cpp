...
void yNswitch(bool &again)
{
    ...
    else if('n' == tolower(yOrN))
    {
        again = false;
        break;
    }
    else
        cout << "Wrong answer, please enter 'Y' if you want to play again or 'N' if you want to return to the menu" << endl;
    }while(1==1);
}
/*
     Function   :   yNswitch
